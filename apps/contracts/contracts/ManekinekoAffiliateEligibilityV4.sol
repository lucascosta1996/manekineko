...
contract ManekinekoAffiliateEligibilityV4 is Ownable2Step, ReentrancyGuard {
    string public constant ELIGIBILITY_VERSION = "affiliate-eligibility-v4";
    ...
    /// @dev Existing V5/V6/V7/V8 rounds can be imported as sources after successful completion and can never enroll through this gate.
    function registerCollection(address factory, uint256 id) external onlyOwner nonReentrant returns (address round) {
        ...
        bool sourceOnly = version == keccak256("affiliate-v5") || ((version == keccak256("affiliate-v6") || version == keccak256("affiliate-v7") || version == keccak256("affiliate-v8")) && _completed(candidate));
    ...
    function eligibilityStatus(address target, address applicant, address sourceCollection, uint256 sourceTokenId) public view returns (uint8) {
        ...
        bool v7 = version == keccak256("affiliate-v7") || (version == keccak256("affiliate-v8") || version == keccak256("affiliate-v9"));
    ...
    function _completed(IAffiliateEligibilityRound round) private view returns (bool) {
        ...
        if (version == keccak256("affiliate-v7") || (version == keccak256("affiliate-v8") || version == keccak256("affiliate-v9"))) return round.readyForNextRound();
