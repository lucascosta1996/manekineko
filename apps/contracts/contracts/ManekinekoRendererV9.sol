...
contract ManekinekoRendererV9 {
        ...
        external pure returns (string memory)
    {
        ...
        return string.concat("data:application/json;base64,", Base64.encode(bytes(string.concat(
            ...
            '"artwork_version":"tincta-v2","contract_version":"affiliate-v9","algorithm_version":"unique-rank-v5","randomness_provider":"chainlink-vrf-v2.5",',
