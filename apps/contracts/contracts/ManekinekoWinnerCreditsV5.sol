...
contract ManekinekoWinnerCreditsV5 is Ownable2Step, ReentrancyGuard {
    string public constant WINNER_CREDITS_VERSION = "winner-credits-v5";
    ...
    constructor(address initialOwner, bytes32 historicalWinnerRoot, address priorRegistry) Ownable(initialOwner) {
        ...
        if (priorRegistry != address(0)) {
            ...
            if (priorVersion != keccak256("winner-credits-v2") && priorVersion != keccak256("winner-credits-v3") && priorVersion != keccak256("winner-credits-v4")) revert InvalidCollection();
        }
