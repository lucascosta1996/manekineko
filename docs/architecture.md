...
| `apps/landing-page` | Independently deployable public landing app | Separate from Web and the private console. Do not assume its design is complete because Web is branded. |
